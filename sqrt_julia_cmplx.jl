...
# ╔═╡ 69f939c8-56e4-4bc2-927d-8ca19989f718
using Plots

# ╔═╡ b1b5b18e-f294-447b-b25b-89f8435bf1ec
using PlutoUI

# ╔═╡ c261f1a4-926f-4f56-beb8-4c51b6c921d2
md"## Decomposing a number into squares"

# ╔═╡ a0e0b604-6da3-11ed-2d7c-752bb525a864
function get_squares(num, squares = []; aesthetic=false)
    loop_range = nothing
    part1 = 0
    if aesthetic == true
    ...
    part2 = num - part1
    if part2>0
        get_squares(part2, squares, aesthetic=aesthetic)
    else
        return squares
    end
...
# ╔═╡ 38ac32dd-5507-4cc5-865a-b2c7e5a90e70
get_squares(36)

# ╔═╡ 18413ad9-663a-4897-9607-33b2f84c7b09
md"## The algorithm I came up with!

Involves using the intuition of complex numbers to represent rotations more elegantly
"


# ╔═╡ 9c496826-75b2-4551-a928-5966fc4d04a5
function get_triangle_points(square_decomposition)
	a = map(√,sort(square_decomposition)) 
	p = []
	for i in eachindex(a)
		if i==1
			push!(p, a[i]+0im)
		else
			push!(p, p[i-1]*(1+(a[i]/abs(p[i-1]))im))
		end
	end
	return p
end
...
md"""
`Number to sqrt:` $(@bind num_to_sqrt Slider(1:20, default=3))
